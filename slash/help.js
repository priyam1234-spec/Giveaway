...
module.exports = {
  ...
  run: async (client, interaction) => {
    const embed = new MessageEmbed()
      ...
      .addField(`Links:`, `- [Youtube Channel](https://youtube.com/c/MrPriyam37Gaming)\n- [Discord Server](https://discord.gg/Np9eSQF6GB)\n- [GitHub](https://github.com/priyam1234-spec/Giveaway)`, true)
      .setTimestamp()
      .setFooter({
        text: `Requested by ${interaction.user.username} | GiveawayBot™ v3 By Priyam`,
